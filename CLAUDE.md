...
- 검색엔진 소유확인: 네이버 `51691e19706847a9a5c5fc10713cd83d0ba22a08` · 구글 `72TUSduWAI-AuXDORtu2O4UOV66Y00q2CLItzZ8QHQM` — 홈 `<head>` 에 생성기가 넣는다(`regions.js` 의 `verify`). **`index.html` 에 손으로 넣지 말 것** — 재생성하면 사라진다. 코드를 바꾸려면 `verify` 를 고치고 재생성.
